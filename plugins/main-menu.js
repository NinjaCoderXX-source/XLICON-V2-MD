...
*©★彡[ᴠɪʜᴀɴɢᴀ.𝕩𝕩]彡★*
⍟────────────────⍟
*_Konnichiwa! Its ᗩKEᑎO-ᗰᗪ🧚‍♀️ A_* 
*_Multi-Device Whatsapp BOT_*
*_Recoded By ★彡[ᴠɪʜᴀɴɢᴀ.𝕩𝕩]彡★_*
⍟────────────────⍟
...
┌┤
┃
┃ *_Founder_*: ★彡[ᴠɪʜᴀɴɢᴀ.𝕩𝕩]彡★
┃ *_Bot Name_*: ᗩKEᑎO-ᗰᗪ🧚‍♀️
┃ *_Mode_*: %mode
┃ *_HOST_*: kali Linux
┃ *_Type_*: NodeJs
...
╰──────────────────⦿
 ...
 let contact = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '94714201875@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
